...
import mk.ukim.finki.wp.lab.service.impl.CourseServiceImplemented;
...
public class EditCourseTest {
    ...
    public void init() {
        ...
        courseService = Mockito.spy(new CourseServiceImplemented(courseRepository, studentService, teacherService));
    }
